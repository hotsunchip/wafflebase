...
| 11c | `SceneOutline` · `SceneNodeDetail` · `FloatingClassEditor` | held |
| 12a | `TokenEditorPanel` · `TokenBindingPanel` · `AddTokenRow` | held |
| 12b | `ReviewApproveModal` · `PreviewPane` · the remaining chrome | held |
